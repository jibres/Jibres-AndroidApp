...
//      item_intro_1
      ...
      v1_title = view_1.findViewById(R.id.title_intro1);
      v1_subTitle = view_1.findViewById(R.id.sub_title_intro1);
      v1_desc = view_1.findViewById(R.id.desc_intro1);
//      item_intro_2
      view_2 = itemView.findViewById(R.id.style_2);
      v2_image = view_2.findViewById(R.id.intro_img_intro2);
      v2_title = view_2.findViewById(R.id.title_intro2);
      v2_desc = view_2.findViewById(R.id.desc_intro2);
    }
